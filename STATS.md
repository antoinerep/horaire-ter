...
_Mis à jour le 2026-06-30 02:14 UTC — fenêtre des dernières 24 heures. Trains REGIONAURA uniquement._

## Vue d'ensemble

- **Trains observés** : 253
- **Trains annulés** : 0
- **Trains en retard ≥ 5 min ou annulés** : 20 (7.9 %)
...
xychart-beta
    ...
    x-axis ["06-24", "06-25", "06-26", "06-27", "06-28", "06-29", "06-30"]
    y-axis "Retard (min)" 0 --> 12
    line [6.5, 10.0, 5.0, 0.0, 5.0, 5.0, 0.0]
```
...
xychart-beta
    ...
    line [60.0, 54.6, 15.0, 20.8, 36.4, 13.7, 0.0]
```
...
| 2026-06-30 | 125 | 0 | 0.0 % | à l'heure | à l'heure | à l'heure | à l'heure | à l'heure |
...
xychart-beta
    ...
    line [0.0, 0.0, 9.0, 5.0, 20.0, 5.0, 0.0]
```
...
xychart-beta
    ...
    line [89.4, 11.2, 45.6, 47.9, 20.0, 30.0, 0.0]
```
...
| 2026-06-30 | 38 | 0 | à l'heure | à l'heure | à l'heure | à l'heure | à l'heure |

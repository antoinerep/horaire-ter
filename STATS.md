...
_Mis à jour le 2026-07-07 13:08 UTC — fenêtre des dernières 24 heures. Trains REGIONAURA uniquement._
...
- **Correspondances à St-Étienne Châteaucreux** : 267 analysées, **2 loupées** (0.7 %). Médiane retard ressenti à St-Étienne : 0.0 min.
...
xychart-beta
    ...
    line [60.0, 54.6, 15.0, 20.8, 36.4, 13.7, 10.0, 10.0, 18.7, 15.0, 10.0, 10.0, 10.0, 5.0]
```
...
| 2026-07-07 | 128 | 0 | 0.0 % | à l'heure | à l'heure | à l'heure | à l'heure | 5 min |
...
xychart-beta
    ...
    line [89.4, 11.2, 45.6, 47.9, 20.0, 30.0, 41.5, 30.0, 5.0, 17.2, 0.0, 8.5, 10.0, 3.0]
```

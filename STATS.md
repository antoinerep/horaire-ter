...
_Mis à jour le 2026-08-22 04:56 UTC — fenêtre des dernières 24 heures. Trains REGIONAURA uniquement._

## Vue d'ensemble

- **Trains observés** : 190
- **Trains annulés** : 1
- **Trains en retard ≥ 5 min ou annulés** : 11 (5.8 %)

- **Correspondances à St-Étienne Châteaucreux** : 288 analysées, **3 loupées** (1.0 %). Médiane retard ressenti à St-Étienne : 0.0 min.
...
|---|---|---|---|---|---|
| C18 — Lyon ↔ St-Étienne | 90 | 0 | 1.1 % | 1 min | 6 min |
| P28 — St-Étienne ↔ Le Puy | 34 | 0 | 0.0 % | à l'heure | 3 min |
| C18+P28 (through-service) | 66 | 1 | 1.5 % | à l'heure | 10 min |
